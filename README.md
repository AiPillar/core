...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [AiPillar](https://github.com/AiPillar) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for AiPillar.
...
```bash
git clone https://github.com/AiPillar/core
cd core
go mod download
```
...
- **GitHub Issues:** [github.com/AiPillar/issues](https://github.com/AiPillar)
- **Discussions:** [github.com/AiPillar/discussions](https://github.com/AiPillar)
